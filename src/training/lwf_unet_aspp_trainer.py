"""LWF-DLR U-Net segmentation training with ASPP + Residual + Weighted CE + Dice Loss."""
...
class DoubleConv(nn.Module):
    ...
    This is the basic building block of U-Net with optional residual connections.
    ...
    def __init__(self, in_channels, out_channels, use_residual=True):
        ...
        # 1×1 convolution for channel matching in residual connection
...
class ASPP(nn.Module):
    ...
    Captures multi-scale context by applying parallel dilated convolutions
    ...
    def __init__(self, in_channels, out_channels, rates=(3, 6, 9, 12)):
        ...
        # Final 1×1 conv to combine all branches
        # Input: (1 + len(rates) + 1) * out_channels from all branches
    ...
    def forward(self, x):
        ...
        # Global pooling + upsample to original size
...
class UNet(nn.Module):
    """Enhanced U-Net with residual connections and ASPP.
    ...
    def forward(self, x):
        ...
        # Bottleneck (with ASPP or standard)
